...
const findIndexOfUniqueCharacterSequence = (str: string, sequenceLength: number, index = 0): number => {
...
const solveDay6 = () => {
  ...
  const indexOf14UniqueCharacters = findIndexOfUniqueCharacterSequence(input, 14);
